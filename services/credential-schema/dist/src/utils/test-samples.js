    ...
    },
    {
        sample: {
            ...
            schema: {
                ...
                $schema: 'https://json-schema.org/draft/2019-09/schema',
                description: 'The holder has completed training for <SKILL> in <ABC_Institute>.',
                type: 'object',
                properties: {
                    skill: {
                        type: 'string',
                    ...
                    certifyingInstitute: {
                        type: 'string',
                        description: 'Name of the instute which certified the holder being skilled in the said skill',
                    },
                    trainingInstitute: {
                        type: 'string',
        ...
        sample: {
            ...
            schema: {
                ...
                properties: {
                    ...
                    organisingInstitute: {
                        type: 'string',
                        description: 'Name of the institute which organised the examination.',
                    },
                },
                required: [
                    'score',
...
//# sourceMappingURL=test-samples.js.map