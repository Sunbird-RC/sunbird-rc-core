...
func (o *GetV1SchemaNameSampleCsvNotFound) WithPayload(payload string) *GetV1SchemaNameSampleCsvNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get v1 schema name sample csv not found response
func (o *GetV1SchemaNameSampleCsvNotFound) SetPayload(payload string) {
	o.Payload = payload
}
