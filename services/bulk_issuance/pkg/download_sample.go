...
func (controllers *Controllers) downloadSampleFile(params sample_template.GetV1SchemaNameSampleCsvParams, principal *models.JWTClaimBody) middleware.Responder {
	...
	sampleCSVBytes, err := controllers.services.GetSampleCSVForSchema(params.SchemaName)
	if err != nil {
