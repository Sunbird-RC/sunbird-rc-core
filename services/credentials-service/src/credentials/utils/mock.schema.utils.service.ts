...
@Injectable()
export class MockSchemaUtilsSerivce {
  ...
  async getCredentialSchema(schemaId: string) {
    const mockCredentialSchema = {
      ...
      tags: ['tag1', 'tag2'],
      status: 'DRAFT',
      createdAt: '2023-07-06T06:46:51.282Z',
      updatedAt: '2023-07-06T06:46:51.282Z',
      createdBy: null,
      updatedBy: null,
      deprecatedId: null,
    };
    return mockCredentialSchema.schema.schema;
  }
  ...
  async getTemplateById(templateId: string) {
    const mockTemplate = {
      ...
      type: 'Handlebar',
      createdAt: '2023-07-06T06:49:27.168Z',
      updatedAt: '2023-07-06T06:49:27.168Z',
      createdBy: null,
      updatedBy: null,
    };
    return mockTemplate;
