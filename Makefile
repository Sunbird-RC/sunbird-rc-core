...
release: test
	...
	docker tag dockerhub/sunbird-rc-credentials-service dockerhub/sunbird-rc-credentials-service:$(RELEASE_VERSION)
	...
	docker push dockerhub/sunbird-rc-credentials-service:$(RELEASE_VERSION)
