...
public class SearchDaoImplTest extends RegistryTestBase {
	...
	@Test
	public void test_search_by_property()
			throws AuditFailedException, EncryptionException, RecordNotFoundException, DuplicateRecordException {
		String response = addEntity();
		SearchQuery searchQuery = new SearchQuery();
		searchQuery = getSearchQuery(searchQuery,
				getFilter("http://example.com/voc/teacher/1.0.0/schoolName", "Bluebells"),
	...
	@Test
	public void test_search_by_edge()
			throws AuditFailedException, EncryptionException, RecordNotFoundException, DuplicateRecordException {
		String response = addEntity();
		SearchQuery searchQuery = new SearchQuery();
		searchQuery = getSearchQuery(searchQuery,
				getFilter("http://example.com/voc/teacher/1.0.0/area",
						"http://example.com/voc/teacher/1.0.0/AreaTypeCode-URBAN"),
				"http://example.com/voc/teacher/1.0.0/School");
		Map<String, Graph> responseGraph = searchDao.search(searchQuery);
		assertTrue(!responseGraph.isEmpty());
		assertTrue(responseGraph.size() == 1);
	...
	@Test
	public void test_search_multiple_records_by_property()
			throws AuditFailedException, EncryptionException, RecordNotFoundException, DuplicateRecordException {
	...
	@Test
	public void test_search_multiple_records_by_edge()
			throws AuditFailedException, EncryptionException, RecordNotFoundException, DuplicateRecordException {
		String response1 = addEntity();
		String response2 = addEntity();
		String response3 = addEntity();
	...
	@Test
	public void test_search_before_and_after_updating_property_and_adge()
			throws AuditFailedException, MultipleEntityException, EncryptionException, RecordNotFoundException,
			DuplicateRecordException, EntityCreationException {
		String response = addEntity();
		SearchQuery searchQuery = new SearchQuery();
		searchQuery = getSearchQuery(searchQuery,
				getFilter("http://example.com/voc/teacher/1.0.0/schoolName", "Bluebells"),
		...
		removeStatementFromModel(addedModel,
				ResourceFactory.createProperty("http://example.com/voc/teacher/1.0.0/schoolName"));
	...
	private String addEntity()
			throws DuplicateRecordException, AuditFailedException, EncryptionException, RecordNotFoundException {
