...
class RegistryEntityControllerTest {
    ...
    @Test
    void testGetAttestationCertificate_success() throws Exception {
    ...
    @Test
    void testGetAttestationCertificate_failureWhenClaimNotAttested() throws Exception {
    ...
    @Test
    void testGetAttestationCertificate_failureWhenUserNotAllowed() throws Exception {
        String response = "{\"Institute\": {\"instituteAffiliation\": [{\"osid\": \"456\", \"_osAttestedData\": {\"instituteName\": \"te\", \"affiliationNumber\": \"901\"}}]}}";
        JsonNodeFactory.instance.objectNode();
        JsonNode node = new ObjectMapper().readTree(response);
        Mockito.when(registryHelper.readEntity("anonymous", "Institute", "123", false, null, false))
    ...
    @Test
    void testGetAttestationCertificate_failureIfRecordNotFound() throws Exception {
    ...
    @Test
    void testRevokeACredential_RecordNotFound() throws Exception {
    ...
    @Test
    void testRevokeACredential_UnauthorizedAccess() throws Exception {
        // Mock HttpServletRequest and HttpHeaders
        HttpServletRequest request = mock(HttpServletRequest.class);
        HttpHeaders headers = mock(HttpHeaders.class);
    ...
    @Test
    void testRevokeACredential_CredentialAlreadyRevoked() throws Exception {
    ...
    @Test
    void testRevokeACredential_SuccessfulRevocation() throws Exception {
