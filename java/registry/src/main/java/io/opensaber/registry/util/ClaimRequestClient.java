...
public class ClaimRequestClient {
    ...
    public HashMap<String, Object> riseClaimRequest(String entityName, String entityId, String property, String propertyId) throws Exception {
        ...
        HashMap<String, Object> hashMap = restTemplate.postForObject(claimRequestUrl + claimsPath, claimDetails, HashMap.class);
