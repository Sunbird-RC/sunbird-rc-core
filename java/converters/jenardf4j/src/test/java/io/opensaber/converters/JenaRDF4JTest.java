...
public class JenaRDF4JTest {
	...
	private void buildRDF4J(ModelBuilder builder, String subjectLabel) {
		...
		builder.setNamespace("ex", "http://example.org/").subject(subjectLabel).add(FOAF.FIRST_NAME, "Pablo")
				.add("ex:homeAddress", address).add("ex:creatorOf", painting).subject(address)
